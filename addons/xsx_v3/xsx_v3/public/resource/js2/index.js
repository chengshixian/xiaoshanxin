...
var tuike = {};
$.ajax({
    'url':"/index.php?c=site&a=entry&do=base&op=hospital_arr&m=xsx_v3",
    dataType:"json",
    type:"get",
...
(function () {
    ...
    var valuess = {};
    $.ajax({
    'url':"/index.php?c=site&a=entry&do=base&op=user_arr&m=xsx_v3",
    dataType:"json",
    type:"get",
    success:function(res){
        titless = res.title
...
(function () {
    ...
    $.ajax({
        'url':"/index.php?c=site&a=entry&do=base&op=wenzhen_count&m=xsx_v3",
        dataType:"json",
        type:"get",
        success:function(res){
            var data = {
...
(function () {
    ...
    var week_time = {};
    $.ajax({
        'url':"/index.php?c=site&a=entry&do=base&op=orderss&m=xsx_v3",
        dataType:"json",
        type:"get",
        success:function(res){
...
(function () {
     $.ajax({
        'url':"/index.php?c=site&a=entry&do=base&op=goods_orders&m=xsx_v3",
        dataType:"json",
        type:"get",
        success:function(res){
            var data = res
...
(function () {
    ...
    $.ajax({
        'url':"/index.php?c=site&a=entry&do=base&op=order&m=xsx_v3",
        dataType:"json",
        type:"get",
        success:function(res){
            var data = {
