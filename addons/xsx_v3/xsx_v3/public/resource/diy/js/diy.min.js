define(['jquery.ui', '../../js/goods_selector.js'], function(ui, gSelector) {
	...
	modal.initNavs = function() {
         ...
         * line           辅助线组件        *** blank             辅助空白组件   *** rush_goods     抢购药品组件
         * groupon_goods  团购药品组件      *** fightgroup_goods  拼团药品组件   *** bargain_goods  砍价药品组件
         * public_goods   通用药品组件      *** coupon_goods      卡卷药品组件   *** packages       大礼包药品组件
         * discount_card  折扣卡药品组件    *** community         社群组件       *** shop           商户(商家信息)组件
		...
		$("#diy-editor").on("click", '.select_goods', function() {
			//药品类型 1=抢购(rush)  2=团购(groupon)  3=拼团(wlfightgroup)  5=优惠卷(coupon)
	...
	modal.getNavs = function() {
		//基础组件  nav_class=1:基础组件;   =2：辅助组件;  =3：药品组件;  =4：其它组件
		modal.navs = {
			notice: {
				nav_class: 2,
				group: 'notice',
			...
			rush_goods: {
				...
				params: {
					...
					classs: 0, //按药品分类选择时,药品分类id
					status: 1, //按状态选择时，药品状态
					show_num: 1, //显示的药品数量
				},
				style: {
					'marginBottom': "0",
